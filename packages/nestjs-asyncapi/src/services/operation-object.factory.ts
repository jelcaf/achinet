...
import { AsyncApiOperationOptionsRaw, AsyncMessageObject, AsyncOperationObject, OneOfMessageType } from '../interface';
  ...
  create(
      ...
      return {
        ...
        message: {
          oneOf: oneOf.map((i) => ({
            ...i,
            payload: {
              $ref: getSchemaPath(this.getDtoName(i as AsyncMessageObject, schemas)),
            },
          })),
        },
      };
    ...
    return {
      ...
      message: {
        ...operation.message,
        payload: {
          $ref: getSchemaPath(this.getDtoName(message as AsyncMessageObject, schemas)),
        },
      },
    };
  }

  private getDtoName(message: AsyncMessageObject, schemas: Record<string, SchemaObject>): string {
